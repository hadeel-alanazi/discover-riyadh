    ...
    <div class="row" style="direction:ltr;">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single">Shopping Places</h1>
          <p>Your guide to a unique shopping experience in Riyadh</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="text-section">
  <div class="content">
    <p class="highlight-text">
      Riyadh offers a diverse shopping experience that combines luxurious international brands with local products,
      <br>
      making it an ideal destination for shopping lovers where modern malls meet traditional markets in perfect harmony reflecting the spirit of the city.
    </p>
...
<section class="section-t8 bg-light" style="margin-top: 20px;">
  <div class="container">
    <div class="row">
      <?php
      include 'config.php';
      $sql = "SELECT * FROM shopping_placeseng WHERE type = 'Traditional'";
      ...
      if ($result->num_rows > 0) {
        ...
        echo "<p>No traditional shopping data available.</p>";
      }
      ?>
    </div>
  </div>
...
<section class="text-section">
  <div class="content">
    <p class="highlight-text">
      From the charm of old souqs filled with authenticity and heritage, to the modern malls offering luxury and trendy experiences,
      <br>
      Riyadh harmoniously blends its rich past with its modern present.
    </p>
  </div>
</section>
...
<section class="section-t8 bg-light" style="margin-top: 20px;">
  <div class="container">
    <div class="row">
      <?php
      include 'config.php';
      $sql = "SELECT * FROM shopping_placeseng WHERE type = 'Modern'";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
        $i = 1; 
        while($row = $result->fetch_assoc()) {
        ...
        echo "<p>No modern shopping data available.</p>";
      }
      ?>
    </div>
  </div>
